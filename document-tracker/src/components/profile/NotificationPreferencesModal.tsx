      ...
      <div className="p-6 space-y-6">
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">30 days before expiration</span>
              <Toggle
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">14 days before expiration</span>
              <Toggle
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">7 days before expiration</span>
              <Toggle
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">1 day before expiration</span>
              <Toggle
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">On expiration day</span>
              <Toggle
