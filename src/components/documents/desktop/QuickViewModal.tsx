            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <span className="px-3 py-1 rounded-lg bg-blue-600/20 text-blue-300 text-sm font-medium">
                ...
                <div className="w-1/2 overflow-y-auto p-8">
                  ...
                  <div className="flex items-center gap-3 pt-6 border-t border-white/10">
                    <motion.button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-800 to-blue-600 text-white font-semibold hover:from-blue-600 hover:to-blue-400 transition-all"
                    >
