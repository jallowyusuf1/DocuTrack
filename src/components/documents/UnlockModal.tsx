...
import { Lock, X, AlertCircle, Loader2, Mail, Unlock } from 'lucide-react';
...
export default function UnlockModal({
  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      if (!user) {
        setError('Please log in to unlock documents');
        return;
      }
      ...
      if (profileError || !profile?.lock_password_hash) {
        setError('Lock password not configured');
        return;
      }
      ...
      setError(err.message || 'Failed to unlock document. Please try again.');
      triggerHaptic('heavy');
    } finally {
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Unlock Document</h2>
                <p className="text-sm" style={{ color: '#A78BFA' }}>{documentName}</p>
              </div>
            </div>
            <button
              onClick={onClose}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#A78BFA' }}>
                    For security reasons, please verify your email to continue unlocking documents.
                  </p>
